...
class Zoom_API_Client extends OAuth_API_Client {
	...
	public $oauth_verification_url = 'https://api.zoom.us/v2/users/me';
	...
	public function verify_access_token(){
		// this could call the parent, but essentially this is the end result, added here due to EM 6.3 pending update and an urgent bugfix on here
		$response = $this->get($this->oauth_verification_url);
		$profile_data = (array) $response['body'];
	...
	/**
	 * As of EM 6.4 release this could be removed.
	 *
	 * @return bool
	 * @throws EM_Exception
	 */
	public function revoke_access_token(){
		...
		return $this->oauth_request('post', $this->oauth_revoke_url, $request_args);
	}
